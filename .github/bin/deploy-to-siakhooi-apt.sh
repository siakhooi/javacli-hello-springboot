...
TARGETBRANCH=main
TARGETDIR=apt
TARGET_GIT_EMAIL=javacli-hello-springboot@siakhooi.github.io
TARGET_GIT_USERNAME=javacli-hello-springboot
TARGET_COMMIT_MESSAGE="javacli-hello-springboot: Auto deploy [$(date)]"
